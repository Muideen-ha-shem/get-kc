"""Crawl AppManage (https://ha-shem.com/HAVIS-360/appmanage/) into the
crawled_pages table.
...
AppManage is a single product page on the main ha-shem.com site, so this
...
NOT executed automatically — run manually: `python -m scripts.crawl_appmanage`
"""
