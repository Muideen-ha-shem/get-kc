"""Crawl Havis Xpend (https://ha-shem.com/HAVIS-360/havis-xpend/) into the
crawled_pages table.
...
Havis Xpend is a single product page on the main ha-shem.com site, so this
...
NOT executed automatically — run manually: `python -m scripts.crawl_havis_xpend`
"""
