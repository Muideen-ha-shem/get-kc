"""Crawl V-Login (https://ha-shem.com/HAVIS-360/v-login/) into the
crawled_pages table.
...
V-Login is a single product page on the main ha-shem.com site, so this
...
NOT executed automatically — run manually: `python -m scripts.crawl_vlogin`
"""
