"""Crawl Havis iReport (https://ha-shem.com/HAVIS-360/havis-ireport/) into
...
Havis iReport is a single product page on the main ha-shem.com site, so
...
NOT executed automatically — run manually: `python -m scripts.crawl_havis_ireport`
"""
...
if __name__ == "__main__":
    asyncio.run(
        crawl_site(
            PRODUCT_SITES["Havis iReport"]["url"],
            max_depth=0,
            headless=True,
        )
    )
