"""Crawl Havis Vacay (https://ha-shem.com/HAVIS-360/havis-vacay/) into the
crawled_pages table.
...
Havis Vacay is a single product page on the main ha-shem.com site, so this
...
NOT executed automatically — run manually: `python -m scripts.crawl_havis_vacay`
"""
