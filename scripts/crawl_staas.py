"""Crawl STAAS (https://ha-shem.com/HAVIS-360/staas/) into the
crawled_pages table.
...
STAAS is a single product page on the main ha-shem.com site, so this crawls
only that page (``max_depth=0``, no link-following) rather than
...
NOT executed automatically — run manually: `python -m scripts.crawl_staas`
"""
