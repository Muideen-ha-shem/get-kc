"""Crawl Havis REMA (https://ha-shem.com/HAVIS-360/havis-rema/) into the
crawled_pages table.
...
Havis REMA is a single product page on the main ha-shem.com site, so this
...
NOT executed automatically — run manually: `python -m scripts.crawl_havis_rema`
"""
