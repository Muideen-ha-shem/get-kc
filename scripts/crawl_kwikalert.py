"""Crawl KwikAlert (https://ha-shem.com/HAVIS-360/kwikalert/) into the
crawled_pages table.
...
KwikAlert is a single product page on the main ha-shem.com site, so this
...
NOT executed automatically — run manually: `python -m scripts.crawl_kwikalert`
"""
